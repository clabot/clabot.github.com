<section>
[For individuals: clabot Individual Contributor License Agreement](index.html)

## Entity Contributor License Agreement

Thank you for your interest in contributing to clabot ("We" or "Us").
This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by electronic submission, following the instructions at [https://clabot.github.com/cla/entity.html](https://clabot.github.com/cla/entity.html). This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
...
"Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please follow the instructions in [https://clabot.github.com/cla/entity.html](https://clabot.github.com/cla/entity.html).
...
(d) You have followed the instructions in [https://clabot.github.com/cla/entity.html](https://clabot.github.com/cla/entity.html), if You do not own the Copyright in the entire work of authorship Submitted.
